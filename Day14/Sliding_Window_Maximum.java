...
Start traversing the array from the front using an index i which denotes the end of the current window
such that K - 1 <= i <= N - 1.

1. Remove the items from the back of the deque until the last item is >= the current item to maintain a
...
4. Get the maximum item of the current window which is at the front of the deque. Store the maximum
