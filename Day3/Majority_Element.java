...
We maintain a count/vote of the candidate of the candidate having potential of being majority.
If next candidate is the same increment the vote, else decrement the vote. If vote becomes 0, then update majority
