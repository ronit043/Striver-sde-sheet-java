...
to the max of end of the overlapping intervals. If the list is empty or if the intervals don't overlap, we
add the current interval to the list. At last return the list converted to array.
 */
class Merge_Overlapping_Sub_Intervals {
